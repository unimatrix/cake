...
namespace Unimatrix\Cake\Lib\Min;
 ...
 * - https://github.com/tedious/JShrink/pull/61
 * - https://github.com/tedious/JShrink/pull/59
 * - changed runtime exceptions into cake exceptions
 *
